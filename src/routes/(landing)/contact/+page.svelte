...
{#if isSuccess}
	<div class="flex min-h-screen w-full flex-col items-center justify-center bg-neutral-100">
		<div class="mx-auto w-full max-w-lg px-8 py-16 sm:px-16 sm:py-24 md:px-8 lg:px-16">
			<h1 class="text-center text-2xl font-semibold">Thank you!</h1>
			<p class="text-center text-neutral-600">We'll get back to you as soon as possible.</p>
		</div>
	</div>
{:else}
	<div class="flex min-h-screen w-full flex-col items-center justify-center bg-neutral-100">
