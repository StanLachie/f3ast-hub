	...
	const products: Product[] = [
		{
			...
			features: ['Unlimited Menu Items', 'Unlimited Categories', 'Unlimited Customers']
		},
		{
			name: 'Elite',
			icon: {
			...
			features: ['Everything in Basic', 'Customer Mailing List', 'Customer Inquiries']
		}
	];
	...
	<div class="mx-auto max-w-4xl">
		<div class="flex h-full flex-col items-center justify-center gap-4 text-center">
			...
			<p class="text-neutral-600">
				Select the plan that best fits your business needs and get started today.
			</p>
		</div>
		...
		<div class="my-8 flex flex-col items-center justify-center gap-4">
			<p class=" text-neutral-600 drop-shadow-md">
				Want to see a demo first? <a class="font-semibold text-emerald-300" href="/contact"
					>Contact us</a
				>
			</p>
		</div>
